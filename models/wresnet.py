...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropout_rate=0.0, in_channels=3):
...
def wrn_16_1(num_classes, in_channels=3, dropout_rate=0):
    return WideResNet(depth=16, num_classes=num_classes, widen_factor=1, dropout_rate=dropout_rate, in_channels=in_channels)


def wrn_16_2(num_classes, in_channels=3, dropout_rate=0):
    return WideResNet(depth=16, num_classes=num_classes, widen_factor=2, dropout_rate=dropout_rate, in_channels=in_channels)


def wrn_40_1(num_classes, in_channels=3, dropout_rate=0):
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=1, dropout_rate=dropout_rate, in_channels=in_channels)


def wrn_40_2(num_classes, in_channels=3, dropout_rate=0):
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=2, dropout_rate=dropout_rate, in_channels=in_channels)
